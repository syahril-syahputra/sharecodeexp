...
export const navigation = [    
    ...
    },
    {
      ...
      current: false,
      children: [
        { name: 'Pending Products', href: routeUrl.AdminUrl.componentManagement.pending },
        { name: 'Accepted Products', href: routeUrl.AdminUrl.componentManagement.accepted },
        { name: 'Rejected Products', href: routeUrl.AdminUrl.componentManagement.rejected },
      ],
    },
    {
      name: 'Orders',
