...
export const sellerDahsboard = [
  {
    name: 'Dashboard',
    href: routeUrl.VendorUrl.sellerDahsboard,
    icon: HomeIcon,
    current: false,
  },
]
...
export const buyerDahsboard = [
  {
    name: 'Dashboard',
    href: routeUrl.VendorUrl.buyerDahsboard,
    icon: HomeIcon,
    current: false,
  },
]
...
export const vendorsNavigation = [
  {
    ...
    children: [
      {
        name: 'My Company',
        href: routeUrl.VendorUrl.management.myCompany.details,
      },
      {
        name: 'Subscribers',
        href: routeUrl.VendorUrl.management.contributors.index,
      },
    ],
  },
]
