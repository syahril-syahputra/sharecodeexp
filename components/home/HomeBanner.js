...
export default function HomeBanner() {
  ...
  return (
    <section className=" container relative overflow-hidden">
      <video
        className="w-full md:w-9/12 md:float-right md:-mr-32"
        autoPlay
        muted
        loop
        src="/videos/banner.mp4"
      />
      <div className="md:py-36 text-center md:text-left -mt-32 md:mt-0">
        <div className="text-4xl whitespace-nowrap mb-8 ">
          M2M excess
          <br />
          stock platform.
        </div>
