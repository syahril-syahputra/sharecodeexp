        ...
        <Page size="A4" style={styles.body}>            
            ...
            <View style={styles.sectionItemDetail}>
                <View style={styles.leftColumn}>
                    ...
                    <View style={styles.inlineItem}>
                        ...
                        <Text style={styles.subItem}>
                            : {purchaseOrder.companies_products.company.name}
                        </Text>
                    </View>
                    <View style={styles.inlineItem}>
                        <Text style={styles.subTitleNumber}>
                        ...
                        <Text style={styles.subItem}>
                            : {purchaseOrder.companies_products.company.address}
                        </Text>
                    </View>
                    <View style={styles.inlineItem}>
                        <Text style={styles.subTitleNumber}>
                        ...
                        <Text style={styles.subItem}>
                            : {purchaseOrder.companies_products.company.master_user.name}
                        </Text>
                    </View>
                    <View style={styles.inlineItem}>
                        <Text style={styles.subTitleNumber}>
                        ...
                        <Text style={styles.subItem}>
                            : {purchaseOrder.companies_products.company.phone}
                        </Text>
                    </View>
                    <View style={styles.inlineItem}>
                        <Text style={styles.subTitleNumber}>
                        ...
                        <Text style={styles.subItem}>
                            : {purchaseOrder.companies_products.company.master_user.email}
                        </Text>
                    </View>
                </View>
                <View style={styles.rightColumn}>
                    ...
                    <View style={styles.inlineItem}>
                        ...
                        <Text style={styles.subItem}>
                            : {moment(purchaseOrder.order_date).format('dddd, D MMMM YYYY')}
                        </Text>
                    </View>
                </View>
            </View>
            ...
            <View>
                ...
                <View style={styles.tableBody}>
                    <Text style={styles.pn}>{purchaseOrder.companies_products.ManufacturerNumber}</Text>
                    <Text style={styles.description}>{purchaseOrder.companies_products.Description}</Text>
                    <Text style={styles.mfg}>{purchaseOrder.companies_products.Manufacture}</Text>
                    <Text style={styles.dc}>{purchaseOrder.companies_products.dateCode}</Text>
                    <Text style={styles.qty}>{purchaseOrder.qty}</Text>
                    <Text style={styles.unitPrice}>{purchaseOrder.price_profite}</Text>
                    <Text style={styles.total}>{purchaseOrder.price* purchaseOrder.qty}</Text>
                </View>
                ...
                <View style={styles.tableBody}>
                    ...
                    <Text style={styles.grandTotal}>{purchaseOrder.price* purchaseOrder.qty}</Text>
                </View>
            </View>

            <View style={{marginTop: 15}}>
                <Text style={styles.noteTitle}>Terms & Conditions</Text>
                <Text style={styles.noteItem}>SHIPPED VIA: {'---'}</Text>
                <Text style={styles.noteItem}>SHIPPING DATE: {'---'}</Text>
            </View>
