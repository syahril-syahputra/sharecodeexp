      ...
      <View style={styles.sectionItemDetail}>
        ...
        <View style={[styles.sectionColumn]}>
          ...
          <View style={styles.inlineItem}>
            <Text style={styles.sectionSubTitle}>Company Name</Text>
            <Text style={styles.subItem}>
              : {labPackingList.ship_and_returned.name}
            </Text>
          </View>
          <View style={styles.inlineItem}>
            <Text style={styles.sectionSubTitle}>Address</Text>
            <Text style={styles.subItem}>
              : {labPackingList.ship_and_returned.address}
            </Text>
          </View>
          <View style={styles.inlineItem}>
            <Text style={styles.sectionSubTitle}>City/Country</Text>
            <Text style={styles.subItem}>
              : {labPackingList.ship_and_returned.city} /{' '}
              {labPackingList.ship_and_returned.country}
            </Text>
          </View>
          <View style={styles.inlineItem}>
            <Text style={styles.sectionSubTitle}>Phone Number</Text>
            <Text style={styles.subItem}>
              : {labPackingList.ship_and_returned.phone}
            </Text>
          </View>
          <View style={styles.inlineItem}>
            <Text style={styles.sectionSubTitle}>E-mail</Text>
            <Text style={styles.subItem}>
              : {labPackingList.ship_and_returned.email}
            </Text>
          </View>
        </View>
        <View style={[styles.sectionColumn]}>
          <View style={styles.inlineItem}>
            <Text style={styles.sectionSubTitle}>RETURNED TO</Text>
          </View>
          <View style={styles.inlineItem}>
            <Text style={styles.sectionSubTitle}>Company Name</Text>
            <Text style={styles.subItem}>
