    ...
    <Document pageMode="fullScreen">
      <Page size="A4" style={styles.body}>
        ...
        <View style={styles.quotationItemDetail}>
          <View style={styles.leftColumn}>
            <View style={styles.inlineItem}>
              <Text style={styles.subTitleNumber}>Quotation Number</Text>
              <Text style={styles.subItem}>
                : {quotation?.quotation_info?.number || '-'}
              </Text>
            </View>
            <View style={styles.inlineItem}>
              <Text style={styles.subTitleNumber}>Quotation Date</Text>
              <Text style={styles.subItem}>
                :{' '}
                {moment(quotation?.quotation_info?.date).format(
                  'dddd, D MMMM YYYY'
                )}
              </Text>
            </View>
          ...
          <View style={styles.rightColumn}>
            <View style={styles.inlineItem}>
              <Text style={styles.subTitleNumber}>Quotation Details</Text>
            </View>
            <View style={styles.inlineItem}>
              <Text style={styles.subTitleNumber}>Shipping Term</Text>
              <Text style={styles.subItem}>
                : {quotation?.quotation_info?.shipping_term || '-'}
              </Text>
            </View>
            <View style={styles.inlineItem}>
              <Text style={styles.subTitleNumber}>Payment Term</Text>
              <Text style={styles.subItem}>
        ...
        <View style={styles.quotationItemDetail}>
          <View style={styles.leftColumn}>
            <View style={styles.inlineItem}>
              <Text style={styles.subTitleBuyer}>From</Text>
              <Text style={styles.subItem}>
                : {quotation?.quotation_info?.from}
              </Text>
            </View>
            <View style={styles.inlineItem}>
              <Text style={styles.subTitleBuyer}>To</Text>
              <Text style={styles.subItem}>
        ...
        <View style={{ marginTop: 15 }}>
          ...
          <Text style={styles.noteItem}>
            Please note that the stocks and prices are subject to change every
            day. Units and prices presented in this offer is valid 1 day.
          </Text>
          <Text style={styles.noteItem}>
            Estimated delivery is based upon availability at time of quotation.
          </Text>
        </View>
