...
export default function ExcelComponent(props) {
    ...
    return (
        <Modal show={isOpenConfirmDelete} size="md" popup onClose={() => setIsOpenConfirmDelete(undefined)} className="z-50">

            <Modal.Body>
                <div className="text-center">
                    <ExclamationCircleIcon
                        className=" h-28 w-28 text-gray-400 mx-auto"
                    />

                    <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                        Are you sure you want to delete this File "{props.fileName}" ?
                    </h3>
                    {error && <Alert
                        color="failure"
