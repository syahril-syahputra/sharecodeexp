        ...
        <BaseTable
          header={
            <>
              ...
              <th className="px-6 py-3 text-left">Exepart Visit</th>
              <th className="px-6 py-3 text-left">Company Orders</th>
              <th className="px-6 py-3 text-left">Cancelled Orders</th>
            </>
          }
          tableData={
            <>
              {data.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">{item.visitors_count}</td>
                    <td className="px-6 py-4">{item.total_completed}</td>
                    <td className="px-6 py-4">{item.total_cancelled}</td>
                  </tr>
                )
              })}
