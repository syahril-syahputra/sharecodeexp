        ...
        <div className="relative w-full h-full max-w-lg md:h-auto">
          <div className="border-0 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200">
              <h3 className={`text-xl ${props.className}`}>{props.title}</h3>
              <div
            ...
            <div className="relative p-6">{props.body}</div>
...
export function BaseModalXLarge(props) {
  return (
    <>
      <div className="justify-center my-16 mx-8 items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
