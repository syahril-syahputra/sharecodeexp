      ...
      <button
        ...
        className={classNames(
          props.disabled
            ...
            : 'border border-red-500 text-red-500 hover:text-white hover:bg-red-500 focus:border-red-500 focus:ring shadow hover:shadow-lg ease-linear transition-all duration-150',
  ...
  return (
    <button
      ...
      className={classNames(
        props.disabled
          ? 'bg-red-300'
          : 'bg-red-500 active:bg-red-600 shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150',
