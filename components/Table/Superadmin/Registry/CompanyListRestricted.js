...
export default function CompanyListRestricted(props) {
  return (
    <>
      <PrimaryWrapper>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <CompanyStatus
                        ...
                        title={`stock status ${item.is_confirmed}`}
                        label={item.is_confirmed}
                      />
                    </td>

                    <td className="px-6 py-4 text-center">
                      {parseInt(item.buying_restriction) === 0 ? (
                    ...
                    <td className="px-6 py-4 text-center">
                      {parseInt(item.selling_restriction) === 0 ? (
                        <i className="fa-solid fa-ban  text-red-600 text-2xl"></i>
                      ) : (
                        <i className="fa-solid fa-check  text-green-600 text-2xl"></i>
                      )}
