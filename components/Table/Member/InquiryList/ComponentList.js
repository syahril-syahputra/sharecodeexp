                                        ...
                                        <td className="py-2 text-right w-32">
                                            <div className="inline-flex">
                                                <WarningButton
                                                    size="sm"
                                                    className="mr-2"
                                                    onClick={() => props.handleEdit(item.id, item.qty, item.companies_products.ManufacturerNumber)}
                                                >
                                                    Edit
                                                </WarningButton>
                                                <PrimaryButton
                                                    size="sm"
                                                    className="mr-2 w-20"
                                                    onClick={() => props.handleInquiryNow(item.id, item.qty, item.companies_products.ManufacturerNumber)}
                                                >
                                                ...
                                                <DangerButton
                                                    size="sm"
                                                    className="mr-2"
                                                    onClick={() => props.handleDelete(item.id, item.companies_products.ManufacturerNumber)}
                                                >
                                                    Delete
                                                </DangerButton>
                                            </div>
