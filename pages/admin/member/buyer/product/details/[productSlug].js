...
export default function AddToInquiryList({session, routeParam}) {
    ...
    const handleInquireNow = async (e) => {
        e.preventDefault()
        setIsLoading(true)
        setErrorInfo({})
        const response = await axios.post(`/buyer/order/create-inquiry`, {
        ...
        .then((response) => {
            ...
            router.push(`/admin/member/buyer/inquired-product`)
            toast.success(response.data.message, toastOptions)
        }).catch((error) => {
            toast.error(`Something went wrong. Cannot inquire the product. ${error.data.message}`, toastOptions)
