...
export default function HelpRequest({ session }) {
  ...
  async function searchData(searchParam = '', page = 1) {
    ...
    await axios
      .get(
        `/member/help-request?page=${page}&search=${searchParam}&sort_by=updated_at&sort_type=DESC&start_date&end_date`,
        {
          headers: {
