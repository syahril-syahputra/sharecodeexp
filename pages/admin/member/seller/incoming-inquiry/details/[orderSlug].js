...
export default function InquiryDetails({session, routeParam}) {
    ...
    const loadData = async () => {
        setIsLoading(true)
        setErrorInfo({})
        const response = await axios.get(`/seller/order/${routeParam.orderSlug}/detail`,
            {
            headers: {
    ...
    const verifyInquiryModalHandle = async (inputData) => {
        setIsLoading(true)
        setErrorInfo({})
        const response = await axios.post(`/seller/order/verify-inquiry`, {
        ...
        .then((response) => {
            ...
            toast.error("Something went wrong. Cannot verify inquiry.", toastOptions)
    ...
    const rejectInquiryModalHandle = async (inputData) => {
        setIsLoading(true)
        setErrorInfo({})
        const response = await axios.post(`/seller/order/reject-inquiry`, {
            order_slug: data.slug,
            ...inputData
        }, 
        {
        ...
        .then((response) => {
            ...
            toast.error("Something went wrong. Cannot reject inquiry.", toastOptions)
            setErrorInfo(error.data.data)
        }).finally(() => {
            setIsLoading(false)
        })
    ...
    const [updateVerifiedInquiryModal, setUpdateVerifiedInquiryModal] = useState(false)
    const updateVerifiedInquiryHandle = async (inputData) => {
        setIsLoading(true)
        setErrorInfo({})
        const response = await axios.post(`/seller/order/update-verified-inquiry`, {
            order_slug: data.slug,
            ...inputData
        }, 
        {
        ...
        .then((response) => {
            ...
            toast.error("Something went wrong. Cannot update verified inquiry.", toastOptions)
            setErrorInfo(error.data.data)
        }).finally(() => {
            setIsLoading(false)
        })
    ...
    const shipProductHanlde = async (trackingNumber) => {
        setIsLoading(true)
        setErrorInfo({})
        const response = await axios.post(`/seller/order/shipping-product`, {
            order_slug: data.slug,
        ...
        .then((response) => {
            ...
            toast.error("Something went wrong. Cannot ship the product.", toastOptions)
            setErrorInfo(error.data.data)
        }).finally(() => {
            setIsLoading(false)
        })
    ...
    const uploadInvoiceHandler = async (invoice) => {
        ...
        const response = await axios.post(`/seller/order/upload-invoice`, formData, 
        {
            headers: {
                "Authorization" : `Bearer ${session.accessToken}`
            }
        ...
        .then((response) => {
            ...
            toast.error("Something went wrong. Cannot upload the invoice.", toastOptions)
            setErrorInfo(error.data.data)
        }).finally(() => {
            setIsLoading(false)
        })
