...
export default function MasterAccount({session, dataUser}) {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await axios.post(`/admin/users/update`, inputData, {
            headers: {
                "Authorization" : `Bearer ${session.accessToken}`
            }
        })
                ...
                <div className="mb-0 px-4 py-3 border-0 bg-white">
                    <div className="flex justify-between">
                        ...
                        <div className="px-4 mt-2">
                            <Link href={`/admin/superadmin/usercontrol/master`} className="relative bg-blueGray-700 p-2 text-white">
