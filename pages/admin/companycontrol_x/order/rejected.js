...
import OrderList from "@/components/Table/CompanyControl/OrderList";
      ...
      <div className="mb-0 px-4 py-3 border-0 bg-white">
          <div className="flex justify-between">
              ...
              <div className="px-4 my-2">
                  <Link href="/admin/companycontrol/order/pending" className="m-1 relative bg-orange-500 p-2 text-white">
                      <i className="mr-2 ml-1 fas fa-clock text-white"></i>
                      Pending Order</Link>
                  <Link href="/admin/companycontrol/order/rejected" className="m-1 relative bg-red-500 p-2 text-white">
