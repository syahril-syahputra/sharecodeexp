...
export default function ComponentList() {
  ...
  const tableHeader = useRef(['First Name', 'Last Name', 'Age', 'Action'])
    ...
    <div className="relative p-2 bg-white mb-20">
      ...
      <div className="text-center pb-10 mt-10">
        ...
        <div className="text-center pb-2">
          ...
          <SecondaryButton className="m-1" size="" disabled={isDisabled}>
            Secondary
          </SecondaryButton>
          <SuccessButton className="m-1" size="" disabled={isDisabled}>
            Success
          </SuccessButton>
          <DangerButton className="m-1" size="" disabled={isDisabled}>
            Danger
          </DangerButton>
          <WarningButton className="m-1" size="" disabled={isDisabled}>
            Warning
          </WarningButton>
          <InfoButton className="m-1" size="" disabled={isDisabled}>
            Info
          </InfoButton>
          <LightButton className="m-1" size="" disabled={isDisabled}>
            Light
          </LightButton>
        </div>
        <div className="text-center pb-2">
          <PrimaryButton className="m-1" size="" disabled={isDisabled} outline>
            <i className="fas fa-envelope mr-2"></i>Primary
          </PrimaryButton>
          <SecondaryButton
            className="m-1"
            size=""
          ...
          <SuccessButton className="m-1" size="" disabled={isDisabled} outline>
            Success
          </SuccessButton>
          <DangerButton className="m-1" size="" disabled={isDisabled} outline>
            Danger
          </DangerButton>
          <WarningButton className="m-1" size="" disabled={isDisabled} outline>
            Warning
          </WarningButton>
          <InfoButton className="m-1" size="" disabled={isDisabled} outline>
            Info
          </InfoButton>
          <LightButton className="m-1" size="" disabled={isDisabled} outline>
            Light
          </LightButton>
        </div>
        <div className="text-center pb-2">
          ...
          <PrimaryButton className="m-1" size="lg" disabled={true} outline>
            Primary
          </PrimaryButton>
        </div>
        <div className="text-center pb-2">
          <PrimaryButton className="m-1" size="sm" disabled={true}>
            <i className="fas fa-envelope mr-2"></i>Primary
          </PrimaryButton>
          <PrimaryButton className="m-1" size="md" disabled={isDisabled}>
            Primary
          </PrimaryButton>
          <PrimaryButton className="m-1" size="lg" disabled={isDisabled}>
            Primary
          </PrimaryButton>
        </div>
      </div>
