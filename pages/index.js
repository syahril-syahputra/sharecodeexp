          ...
          <div className="">
            ...
            <div className="w-full px-12 md:px-4 ml-auto mr-auto">
              <div className="text-center items-stretch mb-3 mt-3">
                ...
                <input type="text" placeholder="Search for the components" className="border-0 md:w-8/12 px-3 py-4 placeholder-slate-300 text-slate-600 relative bg-white bg-white text-base shadow outline-grey focus:outline-none focus:ring w-full pl-10"/>
              </div>  
              <div className="text-center">
                <button
                  className="mt-4 text-white font-bold px-6 py-2 outline-none focus:outline-none mr-1 mb-1 bg-blueGray-700 active:bg-blueGray-600 uppercase text-sm shadow hover:shadow-lg"
                >
                  Search
                </button>
              </div>
      ...
      <section className="pb-40 relative bg-blueGray-100">
        <div className="container mx-auto">
          ...
          <div className="mb-4 text-end  mt-14">
            <Link href="/" className="font-medium text-blueGray-700 underline">View all Components</Link>
          </div>
