...
import TextInputPhoneValidateDark from '@/components/Interface/Form/TextInputPhoneValidateDark'
import SelectInputSectorDark from '@/components/Interface/Form/SelectInputSectorDark'
import CountrySelectorDark from '@/components/Shared/CountrySelectorDark'
import ProvinceSelectorDark from '@/components/Shared/ProvinceSelectorDark'
...
function Register() {
  ...
  const validationSchema = Yup.object({
    ...
    company_code_country: Yup.mixed().required(
      'The company code country field is required'
    ),
...
Register.layout = LayoutLandingPage
